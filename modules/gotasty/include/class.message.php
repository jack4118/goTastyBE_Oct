...
//                $message['created']   = $result['created_at'];
        ...
        **/
        public function createMessageOut($messageCode, $content = NULL, $subject = NULL, $find = array(), $replace = array(), $scheduledAt = '', $priority = 1, $clientEmail, $reference_id=0)
        {
            ...
            if($clientEmail)
            {
                $clientDetail['recipient'] = $clientEmail;
                $clientDetail['type'] = 'email';
                $msgAssignedResult[] = $clientDetail;   
            }
            $db->where('code', $messageCode);
		    ...
		    $insertData['reference_id'] = $reference_id;
