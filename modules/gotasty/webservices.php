<?php
    ...
    $filterCommands = array("setLanguage","getSO_NO","recordFpxChecksum","adminLogin", "memberLogin", "getRegistrationDetailMember", "publicRegistration", "publicRegistrationConfirmation", "memberRegistrationAdmin", "memberRegistrationConfirmationAdmin", "getRegistrationPaymentDetailMember", "getRegistrationPackageDetailMember", "sendOTPCode", "sendOTPCodeDouble", "memberResetPassword", "theNuxFundInCallBack", "apiRegistration", "apiLogin", "requestOTP", "apiInboxUnreadMessage", "apiDashboardDetails", "apiNewsDisplay", "apiWalletDetails", "apiWalletTransfer", "apiWalletWithdrawal", "apiDocumentDownloadList", "apiDocumentDownload", "apiEditMemberDetailMember", "apiGetCoinRate", "apiBuildRegistration", "apiGetTreeSponsor", "apiGetSponsorTreeVerticalView", "apiGetAffiliateBonusList", "apiChangeTransactionPassword", "apiForgotLoginPassword", "apiForgotTransactionPassword", "apiGetProfileDetails", "apiGetWalletHistory", "apiGetBtcData","getAllLanguage","getLanguageVersion","getLanguageList","recordPerformance","addKYC","theNuxFundOutCallback","getDeliveryOrderDetail", "getBuyProductDetails", "getProductIDForSearch", "addTicket", "addPublicTicket", "getTicketList","getECatalogueList","getECatalogue", "accountOwnerVerification", "memberResetPasswordVerification","getDashboardBanner", "memberGetMemberName", "memberGetMemoList", "nicepayCallback", "getInvoiceDetail", "accountSignUpVerification", "guestOwnerVerification", "getState", "getCategoryInventoryMember", "getBankDetails", "addNewPayment", "getProviderSettingFPX", "getProductInventoryList", "getProductDetails", "getProductListMember", "updateSaleOrder", "getPaymentDeliveryOptions", "FPXBackendVerify", "uploadReceipt", "getDeliveryMethod", "CheckOutCalculation", "updateStatusOnCheckout", "getSaleDetail", "addShoppingCart", "getSOShoppingCart", "removeShoppingCart", "appAdminLogin", "getProductDetailsBySN", "CartTotalAmountCalculation", "applyPromoCode", "getShoppingCart", "submitContactUs", "parcelhubCheckLabel", "parcelhubCreateParcel", "parcelhubCheckTrack", "orderDetailCheck", "getReview", "getGTBanner");

    $filterSpecialCharCommands = array("addReview","theNuxFundInCallBack","theNuxFundOutCallback", "nicepayCallback", "memberLogin", "publicRegistrationConfirmation", "memberResetPassword", "FPXBackendVerify", "addPurchaseRequest", "purchaseOrderEdit", "assignSerial", "confirmSerial", "getPurchaseOrderList", "getPurchaseRequestList", "purchaseRequestEdit", "getProductDetails" ,"getProductList", "uploadReceipt", "getVideoURL", "editProductInventory", "editSupplier", "addCookingSuggestion", "editCookingSuggestion", "getStockExpirationDate", "getCategoryInventoryMember", "appGetPurchaseOrderList", "appGetPurchaseRequestList", "appGetProductList", "appAddPurchaseOrder", "appPurchaseRequestEdit", "appEditSupplier", "editPackageInventory","getSOShoppingCart", "getCustomerDetail", "insertMemberAddress", "editOrderDetails", "memberChangePassword", "changeMemberPassword", "updateBatchProduct", "submitContactUs", "getGTBannerList", "addGTBanner", "editGTBanner");
    ...
    if ($result == 0) {
        ...
        switch ($command) {
            ...
            case "addNewMember":
                $apiType = "insert";
                $outputArray = Admin::addNewMember($msgpackData['params']);
                break;
            ...
            case "deleteShippingAddress":
                $apiType = "update";
                $outputArray = Admin::deleteShippingAddress($msgpackData['params']);
                break; 
            ...
            case "getDeliveryFee":
                $apiType = "get";
                $outputArray = Admin::getDeliveryFee2($msgpackData['params']);
                break;
            ...
            case "saleOrderProcess":
                $apiType = "update";
                $outputArray = Inventory::saleOrderProcess($msgpackData['params']);
                break;
            ...
            case "addGTBanner":
                $apiType = "insert";
                $outputArray = Client::addGTBanner($msgpackData['params']);
                break;

            case "getGTBanner":
                $apiType = "get";
                $outputArray = Client::getGTBanner($msgpackData['params']);
                break;
            
            case "getGTBannerData":
                $apiType = "get";
                $outputArray = Client::getGTBannerData($msgpackData['params']);
                break;
                
            case "getGTBannerList":
                $apiType = "get";
                $outputArray = Client::getGTBannerList($msgpackData['params']);
                break;

            case "editGTBanner":
                $apiType = "insert";
                $outputArray = Client::editGTBanner($msgpackData['params']);
                break;

            case "deleteGTBanner":
                $apiType = "insert";
                $outputArray = Client::deleteGTBanner($msgpackData['params']);
                break;
            ...
            case "addPurchase":
                $apiType = "insert";
                $outputArray = Admin::addPurchase($msgpackData['params']);
                break;
            ...
            case "getStockMovement":
                $apiType = "get";
                $outputArray = Admin::getStockMovement($msgpackData['params']);
                break;

            case "getDownLineList":
                $apiType = "get";
                $outputArray =Client::getDownLineList($msgpackData['params']);
                break;
    
            case "getCustomerReviewDetailAdmin":
                $apiType = "get";
                $outputArray =Client::getCustomerReviewDetailAdmin($msgpackData['params']);
                break;


            case "updateCustomerReview":
                $apiType ="insert";
                $outputArray=Client::updateCustomerReview($msgpackData['params'],$msgpackData['username']);
                break;
            case "getCustomerReviewAdmin":
                $apiType ="get";
                $outputArray =Client::getCustomerReviewAdmin($msgpackData['params']);
                break;
            case "getWishListAdmin":
                $apiType = "get";
                $outputArray = Client::getWishListAdmin($msgpackData['params']);
                break;

            case "getStockExpirationDate":
                $apiType = "get";
                $outputArray = Admin::getStockExpirationDate($msgpackData['params']);
                break;
            ...
            case "getPackageBarcode":
                $apiType = "get";
                $outputArray = Admin::getPackageBarcode($msgpackData['params']);
                break;

            case "cancelledPurchaseRequest":
                $apiType = "insert";
                $outputArray = Admin::cancelledPurchaseRequest($msgpackData['params']);
                break;
            ...
            case 'getVideoURL':
                $apiType = "get";
                $outputArray = Inventory::getVideoURL($params,$userID);
                break;

            case 'getCustomerDetail':
                $apiType = "get";
                $outputArray = Admin::getCustomerDetail($params,$userID);
                break;
            ...
            case 'addNewSO':
                $apiType = "insert";
                $outputArray = Admin::addNewSO2($params);
                break;

            case 'checkStockQuantity':
                $apiType = "get";
                $outputArray = Inventory::checkStockQuantity($params);
                break;

             case 'getProductFavouriteList':
                $apiType="get";
                $outputArray=Inventory::getProductFavouriteList($params);
                 break;
                 
            case 'addProductFavouriteList':
                $apiType="insert";
                $outputArray=Inventory::addProductFavouriteList($params);
                break;

            case 'addFavouriteList':
                $apiType = "insert";
                $outputArray = Inventory::addFavouriteList($params);
                break;

            case 'editFavouriteList':
                $apiType = "insert";
                $outputArray = Inventory::editFavouriteList($params);
                break;
            
            case 'addPackageInventory':
                $apiType = "insert";
                $outputArray = Inventory::addPackageInventory($params);
                break;

            case 'editPackageInventory':
                $apiType = "insert";
                $outputArray = Inventory::editPackageInventory($params);
                break;
            ...
            case "getCookingSuggestion":
                $apiType = "get";
                $outputArray = Inventory::getCookingSuggestion($params);
                break;

            case "getCookingSuggestionDetail":
                $apiType = "get";
                $outputArray = Inventory::getCookingSuggestionDetail($params);
                break;
            ...
            case "getCategoryList":
                $apiType = "insert";
                $outputArray = Inventory::getCategoryList($params);
                break;
            ...
            case "addCookingSuggestion":
                $apiType = "insert";
                $outputArray = Inventory::addCookingSuggestion($params);
                break;

            case "editCookingSuggestion":
                $apiType = "insert";
                $outputArray = Inventory::editCookingSuggestion($params);
                break;
            ...
            case 'createAdminTelegramNotification';
                $apiType = "get";
                $outputArray = Client::sendTelegramMessage($messageCode, NULL, NULL, $find, $replace,"","","telegramAdminGroup");
                break;
            ...
            case "updateBatchProduct":
                $apiType = "get";
                $outputArray = Admin::updateBatchProduct($params);
                break;

            case "getDODetails":
                $apiType = "get";
                $outputArray = Admin::getDODetails($params);
                break;

            case "getDOListing":
                $apiType = "get";
                $outputArray = Admin::getDOListing($params);
                break;
            ...
            case "addReview":
                $apiType ="insert";
                $outputArray =Inventory::addReview($params);
                break;
                
            case "getReview":
                $apiType ="get";
                $outputArray =Inventory::getReview($params);
                break;
            case "sendSalesOrderNotification":
                $apiType ="get";
                $outputArray=Client::sendSalesOrderNotification($params); 
                break;
                
            case "addWishList":
                $apiID = "insert";
                $outputArray = Inventory::addWishList($params);
                break;

            case 'getWishList':
                $apiID = "get";
                $outputArray = Inventory::getWishList($params);
                break;
            ...
            case 'getSOShoppingCart':
                $apiType = "get";
                $outputArray = Inventory::getSOShoppingCart($params);
                break;

            case 'getShoppingCart':
                $apiType = "get";
                $outputArray = Inventory::getShoppingCart2($params);
                break;

            case 'getShoppingCartQuantity':
                $apiType = "get";
                $outputArray = Inventory::getShoppingCartQuantity($params);
                break;
            ...
            case "getListing":
                $apiType = "get";
                $outputArray = Admin::getListing($params);
                break;
            ...
            case 'updatePaymentMethod':
                $apiType = "update";
                $outputArray = Admin::updatePaymentMethod($params);
                break;

            case 'updateSOStatus':
                $apiType = "update";
                $outputArray = Client::updateSOStatus($params);
                break;

            case 'updateGuestToken':
                $apiType = "update";
                $outputArray = Client::updateGuestToken($params);
                break;
            ...
            case 'insertMemberAddress':
                $apiType = "insert";
                $outputArray = Admin::insertMemberAddress($params, $config);
                break;
            ...
            case "getProductDetailsBySN": /* SN = serial number */
                $apiType = "get";
                $outputArray = Inventory::getProductDetailsBySN($params);
                break; 
            ...
            case 'CartTotalAmountCalculation':
                $apiType = "get";
                $outputArray = Cash::CartTotalAmountCalculation($params,$userID);
                break;

            case 'CartTotalAmountCalculationMember':
                $apiType = "get";
                $outputArray = Cash::CartTotalAmountCalculationMember($params,$userID);
                break;
            ...
            case "getProviderSettingFPX":
                ...
                break;
            case "recordFpxChecksum":
                $apiType = "get";
                $outputArray = array('status' => "ok", 'code' => 0, 'statusMsg' => "", 'data' => '');
                break;
            ...
            case "cancelledPurchaseOrder":
                $apiType = "insert";
                $outputArray = Admin::cancelledPurchaseOrder($msgpackData['params']);
                break;
            ...
            case "addNewWarehouse":
                $apiType = "insert";
                $outputArray = Admin::addNewWarehouse($msgpackData['params']);
                break;
            
            case "editWarehouse":
                $apiType = "update";
                $outputArray = Admin::editWarehouse($msgpackData['params']);
                break;

            case "getWarehouseList":
                $apiType = "get";
                $outputArray = Admin::getWarehouseList($msgpackData['params']);
                break;
            ...
            case "orderDetailCheck":
                $apiType = "get";
                $outputArray = Inventory::orderDetailCheck($params);
                break;

            case "getSaleOrderDetails":
                $apiType = "get";
                $outputArray = Inventory::getSaleOrderDetails($params);
                break;

            case "getStockOutDetails":
                $apiType = "get";
                $outputArray = Inventory::getStockOutDetails($params);
                break;
            ...
            case "getStockCount":
                $apiType = "get";
                $outputArray = Admin::getStockCount($params);
                break;

            case "generateStockOutList":
                $apiType = "get";
                $outputArray = Admin::generateStockOutList($params);
                break;

            case "getStockTransferList":
                $apiType = "get";
                $outputArray = Admin::getStockTransferList($params);
                break;

            case "getTransferDetail":
                $apiType = "get";
                $outputArray = Admin::getTransferDetail($params);
                break;

            case "addStockList":
                $apiType = "get";
                $outputArray = Admin::addStockList($params);
                break;

            case "stockInProcess":
                $apiType = "get";
                $outputArray = Admin::stockInProcess($params);
                break;

            case "stockOutProcess":
                $apiType = "insert";
                $outputArray = Admin::stockOutProcess($params);
                break;

            case "editOrderDetails":
                $apiType = "update";
                $outputArray = Inventory::editOrderDetails2($params);
                break;

            case "updateStatusOnCheckout":
                $apiType = "update";
                $outputArray = Inventory::updateStatusOnCheckout($params);
                break;

            case "ActiveSerialCheck":
                $apiType = "update";
                $outputArray = Inventory::ActiveSerialCheck($params);
                break;

            case "updateStatusOnPacking":
                $apiType = "update";
                $outputArray = Inventory::updateStatusOnPacking($params);
                break;

            case "updatePackageStatusOnPacking":
                $apiType = "update";
                $outputArray = Inventory::updatePackageStatusOnPacking($params);
                break;

            case "updateStatusOnTracking":
                $apiType = "update";
                $outputArray = Inventory::updateStatusOnTracking($params);
                break;

            case "updateStatusOnDelivered":
                $apiType = "update";
                $outputArray = Inventory::updateStatusOnDelivered($params);
                break;
    
            case "addPromoCode":
                $apiType = "insert";
                $outputArray = Admin::addPromoCode($params);
                break;

            case "getPromoCodeDetail":
                $apiType = "get";
                $outputArray = Admin::getPromoCodeDetail($params);
                break;

            case "getPromoCodeUserListing":
                $apiType = "get";
                $outputArray = Admin::getPromoCodeUserListing($params);
                break; 
    
            case "updatePromoCodeStatus":
                $apiType = "update";
                $outputArray = Admin::updatePromoCodeStatus($params);
                break;
    
            case "deletePromoCode":
                $apiType = "update";
                $outputArray = Admin::deletePromoCode($params);
                break;
    
            case "getPromoCodeListing":
                $outputArray = Admin::getPromoCodeListing($params);
                break;

            case "applyPromoCode":
                $apiType = "update";
                $outputArray = Inventory::applyPromoCode($params);
                break;

            case "submitContactUs":
                $apiType = "insert";
                $outputArray = Client::submitContactUs($msgpackData['params']);
                break;

            case "insertDeliveryOrder":
                $apiType = "insert";
                $outputArray = Inventory::insertDeliveryOrder($msgpackData['params']);
                break;

            case "DeliveryOrderUpdate":
                $apiType = "insert";
                $outputArray = Inventory::DeliveryOrderUpdate($msgpackData['params']);
                break;

            case "getDeliveryOrder":
                $apiType = "get";
                $outputArray = Inventory::getDeliveryOrder($msgpackData['params']);
                break;

            case "parcelhubCheckLabel":
                $apiType = "get";
                $outputArray = Client::parcelhubCheckLabel($msgpackData['params'], 'parcelhubCheckLabel');
                break;

            case "parcelhubCreateParcel":
                $apiType = "insert";
                $outputArray = Client::parcelhubCreateParcel($msgpackData['params'], 'parcelhubCreateParcel');
                break;

            case "parcelhubCheckTrack":
                $apiType = "get";
                $outputArray = Client::parcelhubCheckTrack($msgpackData['params'], 'parcelhubCreateParcel');
                break;

            case "cancelParcelhub":
                $apiType = "insert";
                $outputArray = Client::cancelParcelhub($msgpackData['params']);
                break;

            case "createEmailNotification":
                $apiType = "get";
                $outputArray = Client::createEmailNotification($msgpackData['params']);
                break;

            case "addPriceList":
                $apiType = "insert";
                $outputArray = Inventory::addPriceList($params);
                break;
            
            case "editPriceList":
                $apiType = "insert";
                $outputArray = Inventory::editPriceList($params);
                break;

            case "viewPriceList":
                $apiType = "get";
                $outputArray = Inventory::viewPriceList($params);
                break;
            
            case "viewPricelistDetail":
                $apiType = "get";
                $outputArray = Inventory::viewPricelistDetail($params);
                break;
            
            case "getProductAndCategory":
                $apiType = "get";
                $outputArray = Inventory::getProductAndCategory($params);
                break;

            case "changeSOItem":
                $apiType = "insert";
                $outputArray = Inventory::changeSOItem($params);
                break;

            case "acceptRejectPurchaseOrder":
                $apiType = "insert";
                $outputArray = Admin::acceptRejectPurchaseOrder($params);
                break;
   
            case "getPostCodeList":
                $apiType = "get";
                $outputArray = Admin::getPostCodeList($params);
                break;
            
            case "getPostCodeData":
                $apiType = "get";
                $outputArray = Admin::getPostCodeData($msgpackData['params']);
                break;

            case "poBatchAction":
                $apiType = "update";
                $outputArray = Inventory::poBatchAction($msgpackData['params']);
                break;

            case "awsGeneratePreSignedUrl":
                $apiType = "get";
                $outputArray = aws::awsGeneratePreSignedUrl($msgpackData['params']);
                break;
	    ...
	    //MOBILE APP
            ...
            case "appPurchaseRequestList":
                $apiType = "get";
                $outputArray = Admin::getPurchaseRequestList($msgpackData['params']);
                break;

            case "appVendorListing":
                $apiType = "get";
                $outputArray = Inventory::getSupplierListing($params);
                break;

            case "appGetPurchaseOrderList":
                $apiType = "get";
                $outputArray = Admin::getPurchaseOrderList($msgpackData['params']);
                break;

            case "appGetSupplierDetail":
                $apiType = "get";
                $outputArray = Inventory::getSupplierDetail($params);
                break;
            ...
            case "appEditSupplier":
                $apiType = "insert";
                $outputArray = Inventory::editSupplier($params);
                break;

            case "appGetPurchaseRequestList":
                $apiType = "get";
                $outputArray = Admin::getPurchaseRequestList($msgpackData['params']);
                break;
            ...
            case "appGetWarehouse":
                $apiType = "get";
                $outputArray = Admin::getWarehouse($msgpackData['params']);
                break;

            case "appGetProductList":
                $apiType = "get";
                $outputArray = Admin::getProductList($msgpackData['params']);
                break;

            case "appAddPurchaseOrder":
                $apiType = "insert";
                $outputArray = Admin::addPurchase($msgpackData['params']);
                break;

            case "appPurchaseRequestEdit":
                $apiType = "insert";
                $outputArray = Admin::purchaseRequestEdit($msgpackData['params'], $msgpackData['username']);
                break;

            case "appPurchaseOrderApprove":
                $apiType = "get";
                $outputArray = Admin::approvePurchaseOrder($msgpackData['params'], $msgpackData['username']);
                break;

            case "appGetPurchaseRequestDetails":
                $apiType = "get";
                $outputArray = Admin::getPurchaseRequestDetails($msgpackData['params']);
                break;


            case "appGetSOListing":
                $apiType = "get";
                $outputArray = Inventory::getInvoiceListing($params,"po");
                break;
            ...
            case "getSO_NO":
                $apiType = "get";
                $outputArray = Cash::getSO_NO($params);
                break;

            case "getJournalLog":
                $apiType = "get";
                $outputArray = Admin::getJournalLog($params);
                break;
